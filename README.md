...
```javascript
  cd projetos
  git clone git@github.com:annabia95/project-talker-manager.git
```
...
Neste projeto, desenvolvi as seguintes habilidades:
 ...
 [Documentação Express - Middleware](https://expressjs.com/pt-br/guide/writing-middleware.html)<br>
 [Node.js // Dicionário do Programador](https://youtu.be/vYekSMBCCiM)<br>
